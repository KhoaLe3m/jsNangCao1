                    ...
                    <tbody>
                        ${data.map((post) => /* html */`
                            ...
                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                ...
                                <a href="admin/edit/${post.id}" type="button" class="inline-block px-6 py-2.5 bg-yellow-500 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-yellow-600 hover:shadow-lg focus:bg-yellow-600 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-yellow-700 active:shadow-lg transition duration-150 ease-in-out">Edit</a>
